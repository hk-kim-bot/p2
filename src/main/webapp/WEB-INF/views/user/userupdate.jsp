...
<header>
					...
					<tr>
						...
						<td><span class="" title="정보변경은 변경칸에서 하실수 있습니다.">${principal.user.phonenumber}</span>
							...
							<c:if test="${principal.user.userauth == 'notauth' }">
								<button id="authProc-btn" onclick="sendsms()">인증문자 보내기</button>
								<br>
								<input type="text" id="authchecking-input"  placeholder="인증번호를 입력해주세요"><button onclick="numbercheck()">인증하기</button>
							</c:if>
						</td>
					</tr>
				</table>
				...
				<table>
					<tr>
						...
						<td>
							...
							<c:if test="${principal.user.userauth == 'notauth' }">
								<button id="authProc-btn" onclick="sendsms()">인증문자 보내기</button><br>
								<input type="text" id="authchecking-input"  placeholder="인증번호를 입력해주세요"><button onclick="numbercheck()">인증하기</button>
							</c:if>
						</td>
					</tr>
  ...
  <script src="/js/authupdate.js"></script>
