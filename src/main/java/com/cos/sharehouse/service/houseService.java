...
import com.cos.sharehouse.model.ReservType;
...
public class houseService {
	...
	public void saveReserv(int id, reserv requestReserv, Users user) {
		...
		requestReserv.setReservtype(ReservType.승인대기);
		reservRepository.save(requestReserv);
	}
	
	@Transactional(readOnly=true)
	public Page<reserv> 예약보기(Users user, Pageable page){
		return reservRepository.findByUsers(user,page);
